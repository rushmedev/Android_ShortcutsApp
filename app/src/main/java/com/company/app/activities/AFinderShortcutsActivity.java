...
public class AFinderShortcutsActivity extends AppCompatActivity {
  ...
  public AFinderShortcutsActivity getContext() {
    return this;
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.a_finder_shortcuts);

    mMainLayout = (LinearLayout) findViewById(R.id.a_finder_shortcuts);
  ...
  private void setup() {
    ...
    AFinderShortcutsActivity.this.setSupportActionBar(appBar);
    ...
    appBar.setNavigationOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            AFinderShortcutsActivity.this.finish();
          }
        });

    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad18);

    adMobBannerAd1.loadAd(new AdRequest.Builder().build());

    this.scrollView1 = (ScrollView1) findViewById(R.id.scroll_view111);
  }
}