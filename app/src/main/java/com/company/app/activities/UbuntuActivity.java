...
public class UbuntuActivity extends AppCompatActivity {
  ...
  public UbuntuActivity getContext() {
    return this;
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mMainLayout = (LinearLayout) findViewById(R.id.ubuntu);
  ...
  private void setup() {
    ...
    UbuntuActivity.this.setSupportActionBar(appBar);
    ...
    appBar.setNavigationOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            UbuntuActivity.this.finish();
          }
        });

    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad19);

    adMobBannerAd1.loadAd(new AdRequest.Builder().build());

    this.scrollView1 = (ScrollView1) findViewById(R.id.scroll_view19);
  }
}