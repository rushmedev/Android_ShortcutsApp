...
public class AppleActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mMainLayout = (LinearLayout) findViewById(R.id.apple);
  ...
  public AppleActivity getContext() {
    return this;
  }
  ...
  private void setup() {
    appBar = (Toolbar) findViewById(R.id.app_bar12);

    AppleActivity.this.setSupportActionBar(appBar);
    ...
    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad13);
