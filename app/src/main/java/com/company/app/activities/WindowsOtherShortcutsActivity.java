...
import com.company.app.elements.windowsothershortcutsactivity.ScrollView1;
import com.google.android.gms.ads.AdView;
import com.google.android.gms.ads.AdRequest;

public class WindowsOtherShortcutsActivity extends AppCompatActivity {
  ...
  public WindowsOtherShortcutsActivity getContext() {
    return this;
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.windows_other_shortcuts);

    mMainLayout = (LinearLayout) findViewById(R.id.windows_other_shortcuts);
  ...
  private void setup() {
    ...
    WindowsOtherShortcutsActivity.this.setSupportActionBar(appBar);
    ...
    appBar.setNavigationOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            WindowsOtherShortcutsActivity.this.finish();
          }
        });

    this.scrollView1 = (ScrollView1) findViewById(R.id.scroll_view115);

    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad1);
