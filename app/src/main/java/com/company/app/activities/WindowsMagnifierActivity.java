...
import com.company.app.elements.windowsmagnifieractivity.ScrollView1;
import com.google.android.gms.ads.AdView;
import com.google.android.gms.ads.AdRequest;

public class WindowsMagnifierActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.windows_magnifier);

    mMainLayout = (LinearLayout) findViewById(R.id.windows_magnifier);
  ...
  public WindowsMagnifierActivity getContext() {
    return this;
  }
  ...
  private void setup() {
    ...
    WindowsMagnifierActivity.this.setSupportActionBar(appBar);
    ...
    appBar.setNavigationOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            WindowsMagnifierActivity.this.finish();
          }
        });

    this.scrollView1 = (ScrollView1) findViewById(R.id.scroll_view16);

    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad116);
