...
public class UbuntuGeneralKeyBoardActivity extends AppCompatActivity {
  ...
  public UbuntuGeneralKeyBoardActivity getContext() {
    return this;
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.ubuntu_general_key_board);

    mMainLayout = (LinearLayout) findViewById(R.id.ubuntu_general_key_board);
  ...
  private void setup() {
    ...
    UbuntuGeneralKeyBoardActivity.this.setSupportActionBar(appBar);
    ...
    appBar.setNavigationOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            UbuntuGeneralKeyBoardActivity.this.finish();
          }
        });

    adMobBannerAd1 = (AdView) findViewById(R.id.ad_mob_banner_ad115);

    adMobBannerAd1.loadAd(new AdRequest.Builder().build());

    this.scrollView1 = (ScrollView1) findViewById(R.id.scroll_view114);
  }
}