package com.company.app.elements.eclipsemacosshortcutsactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view120);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((EclipseMacOSShortcutsActivity) ((ScrollView1) getParent().getParent()).getContext())
    ...
    webView1.loadUrl("https://rebrand.ly/eclipse_mac_os");
