package com.company.app.elements.windowsfileexploreractivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view110);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((WindowsFileExplorerActivity) ((ScrollView1) getParent().getParent()).getContext())
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4548/37667117204_dd32420c39_o.png");
