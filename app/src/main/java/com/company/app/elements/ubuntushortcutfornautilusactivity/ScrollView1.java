package com.company.app.elements.ubuntushortcutfornautilusactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view111);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((UbuntuShortcutForNautilusActivity)
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4570/38505640231_3c0cd15a07_o.png");
