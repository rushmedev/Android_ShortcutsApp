package com.company.app.elements.acutandothercommonshortcutsactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((ACutAndOtherCommonShortcutsActivity)
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4528/26741029969_b6a081a503_o.png");
