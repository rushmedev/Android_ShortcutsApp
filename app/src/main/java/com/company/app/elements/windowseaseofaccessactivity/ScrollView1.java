package com.company.app.elements.windowseaseofaccessactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view116);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((WindowsEaseOfAccessActivity) ((ScrollView1) getParent().getParent()).getContext())
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4535/38375195242_08db6fe534_o.png");
