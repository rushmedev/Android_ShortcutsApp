package com.company.app.elements.windowsnarratorshortcutsactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view119);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((WindowsNarratorShortcutsActivity)
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4536/26687249319_eff38bf795_o.png");
