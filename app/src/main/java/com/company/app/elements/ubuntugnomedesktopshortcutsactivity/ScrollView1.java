package com.company.app.elements.ubuntugnomedesktopshortcutsactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view117);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((UbuntuGNOMEDesktopShortcutsActivity)
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4533/38449905276_fabbf35d31_o.png");
