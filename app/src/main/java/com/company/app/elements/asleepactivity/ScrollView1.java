package com.company.app.elements.asleepactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view17);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((ASleepActivity) ((ScrollView1) getParent().getParent()).getContext())
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4555/26741240769_9057547cbc_o.png");
