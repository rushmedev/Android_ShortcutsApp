package com.company.app.elements.windowsremotedeskactivity;
...
public class ScrollView1 extends ScrollView {
  ...
  public void onFinishInflate() {
    ...
    webView1 = (WebView) findViewById(R.id.web_view115);
    ...
    webView1.setWebViewClient(
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            ((WindowsRemoteDeskActivity) ((ScrollView1) getParent().getParent()).getContext())
    ...
    webView1.loadUrl("https://farm5.staticflickr.com/4579/37698823534_01d13f9e1f_o.png");
